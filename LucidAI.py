...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5643542543:AAFO_vN4zkQ5Sl8AvrxzWsFJd11rJJXzCj4"
else:
    tgkey = tgenv
print(tgenv)
...
def ask(username, botname, question, chat_log=None):
    if chat_log is None:
        chat_log = 'Give precise answer on:\n\n'
    now = datetime.now()
